...
class ServerRouter extends React.Component {
  ...
  render() {
    ...
    return React.createElement(server.Router, _extends({}, props, {
      history: history$$1
    }));
  }
...
function Route(props, context) {
  ...
  return React.createElement(server.Route, _extends$1({}, remainingProps, {
...
class BrowserRouter extends React.Component {
  ...
  render() {
    return React.createElement(server.Router, {
