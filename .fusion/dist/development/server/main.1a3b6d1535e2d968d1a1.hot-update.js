...
class Home extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor() {
    ...
    _defineProperty(this, "computeOutcomes", () => {
      ...
      const outcomes = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.map([0, 1, 2, 3, 4, 5], statRank => {
        ...
        const sorted = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.reduce(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.flattenDeep(rolls), (sorting, roll) => {
        ...
        lodash__WEBPACK_IMPORTED_MODULE_1___default.a.forEach(sorted, (value, key) => {
          mapped.push({
        ...
        const ordered = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.orderBy(mapped, 'outcome', 'desc');
...
//# sourceMappingURL=main.1a3b6d1535e2d968d1a1.hot-update.js.map